      ...
      <section id="skor">
        <div class="container" style="display: flex; justify-content: center;height:70rem">
            <div style="width: 100%;">
               ...
               @if ($room == 1)
                  <h3  style="color: white; text-align:center; padding: 50px 20">Breakout Room 1</h3>
                  <div class="table-responsive" style=" overflow-x: auto; overflow-y: auto; position: relative; padding-bottom: 50px; border-radius: 20px">
              ...
              @foreach ($dataByRoom as $room => $dataa)
               @if ($room == 2)
                  <h3 style="color: white; text-align:center; padding: 50px 20">Breakout Room 2</h3>
                  <div class="table-responsive" style=" overflow-x: auto; overflow-y: auto; position: relative; padding-bottom: 50px; border-radius: 20px">
                                <table class="table table-bordered " style="min-width: 650px; margin-bottom: 0; border-collapse: collapse; ">
                                  <thead style="position: static; top: -1; z-index: 10;">
                                          <tr>
